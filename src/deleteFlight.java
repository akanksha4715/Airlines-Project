...
public class deleteFlight extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel16.setText("PACIFIC AIRLINES");
...
try{
            Class.forName("java.sql.DriverManager");
            java.sql.Connection con = (java.sql.Connection) DriverManager.getConnection("jdbc:mysql://localhost/lufthansa","root","root");
            java.sql.Statement st = (java.sql.Statement)con.createStatement();
            String a = (String) jComboBox1.getSelectedItem();
            String q1 = "delete from airbus where aircraft ='"+a+"';" ;  
             int dialogResult = JOptionPane.showConfirmDialog (this, "Would You Like to continue?");
